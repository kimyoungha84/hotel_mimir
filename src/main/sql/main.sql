...
ALTER TABLE staff_permission ADD CONSTRAINT PK_staff_permission_PERMISSION_ID_CODE PRIMARY KEY (PERMISSION_ID_CODE);
...
ALTER TABLE staff_permission ADD CONSTRAINT FK_staff_permission_TO_STAFF_LOG_IDEN FOREIGN KEY (
		LOG_IDEN
)
REFERENCES LOG_RECORD (
		LOG_IDEN
